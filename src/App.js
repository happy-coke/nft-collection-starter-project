...
const CONTRACT_ADDRESS = "0x3641ac243D93905Fa53774f26a5C38b61855E2e1";
...
const App = () => {
  ...
  const switchUI = () => (
    isLoading ? renderLoadingUI() : renderMintUI()
  );
      ...
      <div className="container">
        <div className="header-container">
          ...
          {currentAccount === ""
            ...
            : switchUI()}
          <p className="sub-text">現在のMINT数は... {tokenId+1}/{TOTAL_MINT_COUNT}</p>
          console.log({tokenId});
          { isLoading ? <p>Loading</p> : <p>Minted</p> }
        </div>
